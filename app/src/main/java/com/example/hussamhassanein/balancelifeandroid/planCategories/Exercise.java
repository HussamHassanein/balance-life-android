...
public class Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* TextView showText =(TextView) findViewById(R.id.textt);
        ...
        String result1=share.getString("Exercise",null);
        if (result1!=null) {
    ...
    public void saveList(View view) {
        ...
        editor.putString("Exercise", listtask.toString());
        editor.commit();
    ...
    public void delettask(View view) {
        ...
        if(editText.getText().toString().equals("")) {
            AlertDialog alertDialog = new AlertDialog.Builder(Exercise.this).create();
